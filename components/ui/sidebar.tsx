  ...
  (
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-sidebar pt-4 pb-2 px-2 text-sidebar-foreground [&>button]:hidden"
            style={
              {
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "fixed top-[--header-height] left-0 z-10 hidden  w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md:flex  px-2 py-4",
            side === "left"
